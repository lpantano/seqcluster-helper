...
summarydata = data.frame(row.names=samples,samples=sample,group=groups)
```
...
```{r de-iso}
dss = do_de(makeCounts(obj, ref=T, iso5=T, iso3=T, add=T, sub=T), summarydata, condition)
```
